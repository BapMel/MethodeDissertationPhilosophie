...
\uline{Une bonne définition doit être nécessaire et suffisante} : on doit
pouvoir aller du concept à la définition \emph{et surtout} de la définition
...
spécifique\footnote{Aristote, \emph{Topiques}, IV, 101b20 ; V, 101b35--102a20.} ; c'est cette dernière qui fait souvent défaut.

Voici la procédure pour parvenir à une bonne définition. 

\begin{enumerate}
\item \uline{Identifier le genre}. Exemple : « la guerre est un conflit ».
\item \uline{La définition est-elle nécessaire ?} En l'occurrence : toute guerre
est-elle un conflit ? Chercher des contre-exemples. Si l'on n'en
trouve pas, passer à l'étape suivante.
\item \uline{La définition est-elle suffisante ?} En l'occurrence : tout conflit
