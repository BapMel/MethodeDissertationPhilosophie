...
XXX ajouter les conseils d'Aristote, \emph{Topiques}, VI~: lieux pour la
définition.
...
un exemple de lecture de copie. 

\par

Le correcteur lit d'abord l'introduction et la conclusion. À~ce stade,
il a souvent une idée de la note à quatre points près. C'est comme s'il
raisonnait par grandes cases~:
\begin{itemize}
