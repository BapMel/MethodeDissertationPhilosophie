...
\begin{enumerate}
\item comment rédiger le brouillon (section \ref{orge848ca7}) ;
\item la composition de l'introduction, du développement et de la conclusion
(sections \ref{org19bfd79} à \ref{orgd74b7d2}) ;
\item un exemple de plan détaillé et de dissertation rédigée
(sections \ref{org212dc79} et \ref{orgb648430}) ;
\item une liste de sujets de dissertation (section \ref{org913bbea}) ;
...
point de vue du sens commun. Voir plus bas la section \ref{orgb88c79e}.

Ensuite, \uline{construisez la problématique} qui permettra de traiter le
sujet. Voir plus bas la section \ref{orgdd39383}.
...
etc.). Voir plus bas la section \ref{org092cb22}.
...
illusion »). Voir plus bas la section \ref{org824434e}.

Enfin, dans le plan détaillé, on doit noter avec soin la \uline{structure
logique de chacune des transitions} (voir la section \ref{org56bc2b4}). Cette
...
Voir plus bas les sections \ref{org19bfd79} sur l'introduction et \ref{orgd74b7d2}
sur la conclusion.

Voir un exemple de dissertation rédigée dans la section \ref{orgb648430}, que
vous pourrez comparer avec le plan détaillé de la section \ref{org212dc79}.

\section{L'introduction}
\label{sec:org35cff13}
\label{org19bfd79}
...
section \ref{org959b49e}) ;

\item \uline{la \emph{définition} des termes du sujet} (voir la section \ref{orgb88c79e}) ;

\item \uline{la construction de la \emph{tension}} (en un ou plusieurs paragraphes :
voir la section \ref{orgdd39383}) ;
...
\label{sec:orgb896ddb}
\label{org30c4768}

\subsection{Les parties}
\label{sec:org7a18202}
\label{org092cb22}
...
sous-parties dans la section \ref{orgb648430}).
