...
5. (à destination des enseignants de philosophie) quelques propositions
...
2. un ou deux paragraphes de /problématisation/ montrant l'existence
   d'une _contradiction apparente à résoudre_ (voir la
...
principale source de hors-sujet_.
...
1. les /interrogations totales/ sont celles qui portent sur
   ...
   arts ? », etc. _Toutes les questions, et elles seules, appellent une
   réponse par oui ou non_ ;

2. les /interrogations partielles/ sont celles qui portent uniquement
   ...
   - un complément d'objet direct (exemple : « /Que/
     désirons-nous ? ») ;
   - un complément d'objet indirect (exemple : « /À qui/ dois-je la
     vérité ? ») ;
   - des compléments circonstanciels (exemples : « /À quoi bon/
     démontrer ? », « /Où/ est le passé ? », « /Quand/ faut-il désobéir
     aux lois ? », « /Comment/ s’orienter dans la pensée ? »,
...
_Le type de question détermine fortement les termes de la contradiction
apparente_ que l'on doit mettre au jour dans les deux paragraphes de
problématisation, après les définitions des termes :

1. si le sujet est une /question totale/, alors l'un des deux
...
En ce sens, vous devez _identifier les « attendus » de la question_, et
les justifier à partir du sens commun. _Ne dites pas surtout pas
« le sujet présuppose que... »_, comme s'il s'agissait de présupposés
...
_Si le sujet est une /question totale/, alors les titres de parties
