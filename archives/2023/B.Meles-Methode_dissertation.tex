...
\begin{enumerate}
\item comment rédiger le brouillon (section \ref{orgbb89ea2}) ;
\item la composition de l'introduction, du développement et de la conclusion
(sections \ref{org57466be} à \ref{org3398109}) ;
\item un exemple de plan détaillé et de dissertation rédigée
(sections \ref{org533abb8} et \ref{org3c25ed2}) ;
\item une liste de sujets de dissertation (section \ref{org5749b82}) ;
...
point de vue du sens commun. Voir plus bas la section \ref{orgf736766}.

Ensuite, \uline{construisez la problématique} qui permettra de traiter le
sujet. Voir plus bas la section \ref{orgcab5bf2}.
...
etc.). Voir plus bas la section \ref{orgbd50133}.
...
illusion »). Voir plus bas la section \ref{org8a88e26}.

Enfin, dans le plan détaillé, on doit noter avec soin la \uline{structure
logique de chacune des transitions} (voir la section \ref{orgd32c25b}). Cette
...
Voir plus bas les sections \ref{org57466be} sur l'introduction et \ref{org3398109}
sur la conclusion.

Voir un exemple de dissertation rédigée dans la section \ref{org3c25ed2}, que
vous pourrez comparer avec le plan détaillé de la section \ref{org533abb8}.

\section{L'introduction}
\label{sec:org19d5ca7}
\label{org57466be}
...
section \ref{orgb92b0c8}) ;

\item \uline{la \emph{définition} des termes du sujet} (voir la section \ref{orgf736766}) ;

\item \uline{la construction de la \emph{tension}} (en un ou plusieurs paragraphes :
voir la section \ref{orgcab5bf2}) ;
...
\label{sec:org0631ad9}
\label{orged17c54}

\subsection{Les parties}
\label{sec:org6cd8d89}
\label{orgbd50133}
...
sous-parties dans la section \ref{org3c25ed2}).
